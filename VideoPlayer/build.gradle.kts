...
rootProject.extra.apply {
    set("PUBLISH_ARTIFACT_ID", "videoPlayer")
}

apply(from = "$rootDir/scripts/publish.gradle")

android {
    namespace = "com.tomorrow.videoplayer"
    compileSdk = 34
...
dependencies {
    ...
    implementation(libraries.google.accompanist)
    implementation(libraries.google.accompanist.perms)
